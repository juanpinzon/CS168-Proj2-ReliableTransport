...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, StartTest, EndTest, NonsenseTest, DuplicateAckTest, BrokenLinkTest
 
    BasicTest.BasicTest(forwarder, "small")
    RandomDropTest.RandomDropTest(forwarder, "small")
    StartTest.StartTest(forwarder, "small")
    EndTest.EndTest(forwarder, "small")
    NonsenseTest.NonsenseTest(forwarder, "small")
    DuplicateAckTest.DuplicateAckTest(forwarder, "small")
    BrokenLinkTest.BrokenLinkTest(forwarder, "small")
    SackRandomDropTest.SackRandomDropTest(forwarder, "small")

    BasicTest.BasicTest(forwarder, "small_img.jpg")
    RandomDropTest.RandomDropTest(forwarder, "small_img.jpg")
    StartTest.StartTest(forwarder, "small_img.jpg")
    EndTest.EndTest(forwarder, "small_img.jpg")
    NonsenseTest.NonsenseTest(forwarder, "small_img.jpg")
    DuplicateAckTest.DuplicateAckTest(forwarder, "small_img.jpg")
    BrokenLinkTest.BrokenLinkTest(forwarder, "small_img.jpg")
    SackRandomDropTest.SackRandomDropTest(forwarder, "small_img.jpg")

    BasicTest.BasicTest(forwarder, "README_GSI")
    RandomDropTest.RandomDropTest(forwarder, "README_GSI")
    StartTest.StartTest(forwarder, "README_GSI")
    EndTest.EndTest(forwarder, "README_GSI")
    NonsenseTest.NonsenseTest(forwarder, "README_GSI")
    DuplicateAckTest.DuplicateAckTest(forwarder, "README_GSI")
    BrokenLinkTest.BrokenLinkTest(forwarder, "README_GSI")
    SackRandomDropTest.SackRandomDropTest(forwarder, "README_GSI")

    BasicTest.BasicTest(forwarder, "bigFile.txt")
    RandomDropTest.RandomDropTest(forwarder, "bigFile.txt")
    StartTest.StartTest(forwarder, "bigFile.txt")
    EndTest.EndTest(forwarder, "bigFile.txt")
    NonsenseTest.NonsenseTest(forwarder, "bigFile.txt")
    DuplicateAckTest.DuplicateAckTest(forwarder, "bigFile.txt")
    BrokenLinkTest.BrokenLinkTest(forwarder, "bigFile.txt")
    SackRandomDropTest.SackRandomDropTest(forwarder, "bigFile.txt")

    BasicTest.BasicTest(forwarder, "huge.txt")
    RandomDropTest.RandomDropTest(forwarder, "huge.txt")
    StartTest.StartTest(forwarder, "huge.txt")
    EndTest.EndTest(forwarder, "huge.txt")
    NonsenseTest.NonsenseTest(forwarder, "huge.txt")
    BrokenLinkTest.BrokenLinkTest(forwarder, "huge.txt")
    SackRandomDropTest.SackRandomDropTest(forwarder, "huge.txt")

    BasicTest.BasicTest(forwarder, "big_img.jpg")
    RandomDropTest.RandomDropTest(forwarder, "big_img.jpg")
    StartTest.StartTest(forwarder, "big_img.jpg")
    EndTest.EndTest(forwarder, "big_img.jpg")
    NonsenseTest.NonsenseTest(forwarder, "big_img.jpg")
    BrokenLinkTest.BrokenLinkTest(forwarder, "big_img.jpg")

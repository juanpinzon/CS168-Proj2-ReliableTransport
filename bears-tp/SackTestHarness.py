...
def tests_to_run(forwarder):
    from tests import BasicTest, SackRandomDropTest, SackRandomDropTest, SackStartTest, SackEndTest, SackNonsenseTest, SackDuplicateAckTest, SackBrokenLinkTest

    BasicTest.BasicTest(forwarder, "small")
    SackStartTest.SackStartTest(forwarder, "small")
    SackEndTest.SackEndTest(forwarder, "small")
    SackNonsenseTest.SackNonsenseTest(forwarder, "small")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "small")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "small")
    SackRandomDropTest.SackRandomDropTest(forwarder, "small")

    BasicTest.BasicTest(forwarder, "small_img.jpg")
    SackStartTest.SackStartTest(forwarder, "small_img.jpg")
    SackEndTest.SackEndTest(forwarder, "small_img.jpg")
    SackNonsenseTest.SackNonsenseTest(forwarder, "small_img.jpg")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "small_img.jpg")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "small_img.jpg")
    SackRandomDropTest.SackRandomDropTest(forwarder, "small_img.jpg")

    BasicTest.BasicTest(forwarder, "README_GSI")
    SackStartTest.SackStartTest(forwarder, "README_GSI")
    SackEndTest.SackEndTest(forwarder, "README_GSI")
    SackNonsenseTest.SackNonsenseTest(forwarder, "README_GSI")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "README_GSI")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "README_GSI")
    SackRandomDropTest.SackRandomDropTest(forwarder, "README_GSI")

    BasicTest.BasicTest(forwarder, "bigFile.txt")
    SackStartTest.SackStartTest(forwarder, "bigFile.txt")
    SackEndTest.SackEndTest(forwarder, "bigFile.txt")
    SackNonsenseTest.SackNonsenseTest(forwarder, "bigFile.txt")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "bigFile.txt")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "bigFile.txt")
    SackRandomDropTest.SackRandomDropTest(forwarder, "bigFile.txt")

    BasicTest.BasicTest(forwarder, "huge.txt")
    SackStartTest.SackStartTest(forwarder, "huge.txt")
    SackEndTest.SackEndTest(forwarder, "huge.txt")
    SackNonsenseTest.SackNonsenseTest(forwarder, "huge.txt")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "huge.txt")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "huge.txt")
    SackRandomDropTest.SackRandomDropTest(forwarder, "huge.txt")

    BasicTest.BasicTest(forwarder, "big_img.jpg")
    SackStartTest.SackStartTest(forwarder, "big_img.jpg")
    SackEndTest.SackEndTest(forwarder, "big_img.jpg")
    SackNonsenseTest.SackNonsenseTest(forwarder, "big_img.jpg")
    SackDuplicateAckTest.SackDuplicateAckTest(forwarder, "big_img.jpg")
    SackBrokenLinkTest.SackBrokenLinkTest(forwarder, "big_img.jpg")
    SackRandomDropTest.SackRandomDropTest(forwarder, "big_img.jpg")
